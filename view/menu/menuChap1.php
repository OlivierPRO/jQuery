<div class = "jumbotron jumbotron-fluid">
    <div class = "container">
        <h1 class = "display-4">chapitre 1</h1>
        <p class = "lead">Je découvre jQuery</p>
        <p class="chapitre1">jQuery est une bibliothèque JavaScript libre et multiplateforme créée pour faciliter l'écriture de scripts côté client dans le code HTML des pages web2. La première version est lancée en janvier 2006 par John Resig.
